...
contextBridge.exposeInMainWorld('studio', {
  ...
  createExperiment: (name, baselineProjectId, projectIds) => ipcRenderer.invoke('library:experiment:create', name, baselineProjectId, projectIds),
  renameExperiment: (id, name) => ipcRenderer.invoke('library:experiment:rename', id, name),
