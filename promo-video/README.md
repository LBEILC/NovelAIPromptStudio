...
这是独立于桌面应用的 Remotion 视频工程 当前主合成为 16:9 1920×1080 30fps 约 74 秒的中文口播 Demo

口播使用用户提供的 MiniMax 成品音频 完整文案与时间轴见 [voiceover-script.md](./voiceover-script.md) 字幕采用 Remotion Caption JSON 并根据静音区间和人工校正后的转写编排
