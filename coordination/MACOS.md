...
- Observed: Windows passed 71 automated tests and the production build. Computer Use verified dark/light switching, saved-theme persistence, bundled CJK typography, library/search/topbar/settings controls, Lobe multi-select, Windows menu suppression, and the full-height theme-root fix. Awaiting macOS install and UI verification.
